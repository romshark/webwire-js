...
export default function SignalMessage(name, payload, encoding) {
	...
	if (typeof payload === 'string' && encoding === "utf8") {
		...
		// Write type flag
		// JavaScript strings are always UTF8 encoded thus the payload must be UTF8 too
	...
	// Encode string into UTF16 payload
		...
		// Write type flag
		// JavaScript strings are always UTF16 encoded thus the payload must be UTF16 too
